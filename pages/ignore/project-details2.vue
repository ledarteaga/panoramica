        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="banner-text wow fadeInUp delay-0-3s">
              Es una empresa líder y pionera en varar embarcaciones de gran
              tonelada, utilizando un sistema varador exclusivo que consiste en
              un vehículo con llantas. De esta forma, se convierte en una
              rápida, segura y económica opción para el sector industrial
