        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="image mb-30 wow fadeInUp delay-0-4s">
              <img src="/assets/images/about/marketing-3.jpg" alt="Project" />
            </div>
          </div>
          <div class="col-lg-6">
            <div class="image mb-30 wow fadeInUp delay-0-4s">
              <img src="/assets/images/about/marketing-5.jpg" alt="Project" />
            </div>
          </div>
          <div class="col-lg-6">
            <div class="image mb-30 wow fadeInUp delay-0-4s">
              <img src="/assets/images/about/marketing-2.jpg" alt="Project" />
            </div>
          </div>
          <div class="col-lg-6">
            <div class="image mb-30 wow fadeInUp delay-0-4s">
              <img src="/assets/images/about/marketing-4.jpg" alt="Project" />
            </div>
          </div>
          <div class="col-lg-6">
            <div class="image mb-30 wow fadeInUp delay-0-4s">
              <img src="/assets/images/about/marketing-6.png" alt="Project" />
            </div>
          </div>
        </div>
