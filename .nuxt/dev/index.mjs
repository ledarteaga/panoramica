...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHost, getRequestProtocol, getQuery as getQuery$1, getRequestHeaders, setHeader, getHeader, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/devalue/index.js';
import destr from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withoutTrailingSlash, withLeadingSlash, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/ufo/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/@unhead/ssr/dist/index.mjs';
import { $fetch as $fetch$1, createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/scule/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola, createConsola } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/errx/dist/index.js';
import { isVNode, toValue, version, unref } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/vue/index.mjs';
import devalue from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/@nuxt/devalue/dist/devalue.mjs';
import BaseStyle from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/@primevue/core/base/style/index.mjs';
import { Theme } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/@primeuix/styled/index.mjs';
import Fuse from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/fuse.js/dist/fuse.mjs';
import { resolve as resolve$1 } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/pathe/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import { diffLines } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/diff/lib/index.mjs';
import MagicString from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/magic-string/dist/magic-string.es.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/ledar/Proyectos/panoramica/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "nuxt-link-checker": {
      ...
      "rootDir": "C:/Users/ledar/Proyectos/panoramica",
    ...
    "groups": [
      {
        ...
        "_rules": [
          ...
          {
            "pattern": "/about-marketing",
            "allow": true
          },
          {
            "pattern": "/about-humanos",
            "allow": true
          },
          {
            "pattern": "/about-finanzas",
            "allow": true
          },
          {
            "pattern": "/nosotros",
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/ledar/Proyectos/panoramica/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\ledar\\Proyectos\\panoramica","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\ledar\\Proyectos\\panoramica\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\ledar\\Proyectos\\panoramica\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\ledar\\Proyectos\\panoramica\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\ledar\\Proyectos\\panoramica\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _UY7Xa3kONM = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/ledar/Proyectos/panoramica";

const appHead = {"link":[{"rel":"icon","type":"image/x-icon","href":"assets/images/favicon.png"},{"rel":"stylesheet","href":"/assets/_css/flaticon.min.css"},{"rel":"stylesheet","href":"/assets/_css/fontawesome-5.14.0.min.css"},{"rel":"stylesheet","href":"/assets/_css/bootstrap.min.css"},{"rel":"stylesheet","href":"/assets/_css/magnific-popup.min.css"},{"rel":"stylesheet","href":"/assets/_css/nice-select.min.css"},{"rel":"stylesheet","href":"/assets/_css/animate.min.css"},{"rel":"stylesheet","href":"/assets/_css/slick.min.css"},{"rel":"stylesheet","href":"/assets/_css/custom.css"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Ayudamos a tu negocio a lograr su máximo potencial."},{"name":"format-detection","content":"telephone=no"},{"name":"keywords","content":"Agencia, Creativa, Marketing, Social Media, Redes Sociales, Instagram, Tiktok, Facebook, Lima, Peru"},{"property":"og:type","content":"website"}],"style":[],"script":[{"src":"https://kit.fontawesome.com/684b6840d3.js","crossorigin":"anonymous"}],"noscript":[],"title":"PANORÁMICA CONSULTING","htmlAttrs":{"lang":"es"}};
...
const _Ck1mkPrqZa = defineNitroPlugin$1(async (nitroApp) => {
...
const _cKdp7eoIGK = defineNitroPlugin$1(async (nitroApp) => {
...
const _8Q3G6D5suT = defineNitroPlugin(async (nitroApp) => {
...
const _XhkBlx = defineEventHandler(async (e) => {
...
const _rDhRcy = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _BrYXEv = defineEventHandler(async (e) => {
...
const _67UoXg = defineEventHandler(async (e) => {
...
const _6eee4D = defineEventHandler(async (e) => {
...
const _u5lHkV = defineEventHandler(async (e) => {
...
const _TFXVd3 = defineEventHandler(async (e) => {
...
const _ljjlV0 = defineEventHandler(async (e) => {
...
const _hjZJc3 = defineEventHandler(async (e) => {
...
const _oHOGkM = defineEventHandler(async (e) => {
...
const _E5pEQv = defineEventHandler(async (e) => {
...
const _CmrVef = defineEventHandler(async (e) => {
...
const pagePaths = [
  ...
  {
    "title": "",
    "link": "/ServieceDetailShowcaseRow"
  },
  {
    "title": "",
    "link": "/shop"
...
const _9GNh2r = defineCachedEventHandler(async (e) => {
  const runtimeConfig = useRuntimeConfig().public["nuxt-link-checker"] || {};
  const linkDb = [
    ...pagePaths
  ];
...
const _I3C9SY = defineEventHandler(async (e) => {
  return {
    runtimeConfig: useRuntimeConfig(e).public["nuxt-link-checker"]
  };
});

const _lazy_Al1ATa = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Al1ATa, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _XhkBlx, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _rDhRcy, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _BrYXEv, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _67UoXg, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug.json', handler: _6eee4D, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _u5lHkV, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _TFXVd3, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _ljjlV0, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _hjZJc3, lazy: false, middleware: false, method: undefined },
  { route: '/__schema-org__/debug.json', handler: _oHOGkM, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _E5pEQv, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/inspect', handler: _CmrVef, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/links', handler: _9GNh2r, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/debug.json', handler: _I3C9SY, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Al1ATa, lazy: true, middleware: false, method: undefined }
];
...
const sources$1 = [
    ...
    },
    {
        ...
        "urls": [
            ...
            {
                "loc": "/project-details2"
            },
            {
                "loc": "/project-details3"
            },
            {
                "loc": "/project-list"
            },
            ...
            {
                "loc": "/service-details2"
            },
            {
                "loc": "/services"
            },
            {
                "loc": "/ServieceDetailShowcaseRow"
            },
            {
                "loc": "/shop"
            },
...
const getClientManifest = () => import('file://C:/Users/ledar/Proyectos/panoramica/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
